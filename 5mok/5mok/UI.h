...
public:
	...
	void PrintRoom_names(vector<char*> room_names, vector<int> room_board_size, vector<char*> room_nicknames);
	...
	int AskWhichRoom(vector<char*> room_names, vector<int> room_board_size, vector<char*> room_nicknames);
